...
def _key_by_value(dictionary, val):
    ...
    for k, v in dictionary.items():
        if v.value == val.value:
            return k
    raise ValueError('Value `' + str(val.value) + '` not found')
...
class Camera(object):
    ...
    def set_param(self, param, val):
        ...
        if not param_name in VAL_TYPE:
            raise RuntimeError('invalid parameter')

        val_type = VAL_TYPE[param_name]
        ...
        if val_type == 'xiTypeString':
            ...
            val_len = DWORD(4)
            val = pointer(ASSOC_ENUM[param_name][val])
...
#-------------------------------------------------------------------------------------------------------------------
    ...
    def get_width_total(self):
        '''
        Total width of the Image provided by the device (in pixels).XI_PRM_WIDTH_TOTAL
        '''
        return self.get_param('width_total')

    def get_width_total_maximum(self):
        '''
        Total width of the Image provided by the device (in pixels).XI_PRM_WIDTH_TOTAL
        '''
        return self.get_param('width_total:max')

    def get_width_total_minimum(self):
        '''
        Total width of the Image provided by the device (in pixels).XI_PRM_WIDTH_TOTAL
        '''
        return self.get_param('width_total:min')

    def get_width_total_increment(self):
        '''
        Total width of the Image provided by the device (in pixels).XI_PRM_WIDTH_TOTAL
        '''
        return self.get_param('width_total:inc')

    def get_height_total(self):
        '''
        Total height of the Image provided by the device (in pixels).XI_PRM_HEIGHT_TOTAL
        '''
        return self.get_param('height_total')

    def get_height_total_maximum(self):
        '''
        Total height of the Image provided by the device (in pixels).XI_PRM_HEIGHT_TOTAL
        '''
        return self.get_param('height_total:max')

    def get_height_total_minimum(self):
        '''
        Total height of the Image provided by the device (in pixels).XI_PRM_HEIGHT_TOTAL
        '''
        return self.get_param('height_total:min')

    def get_height_total_increment(self):
        '''
        Total height of the Image provided by the device (in pixels).XI_PRM_HEIGHT_TOTAL
        '''
        return self.get_param('height_total:inc')
    ...
    def get_regions_geometry(self):
        '''
        Type of multiple regions geometry.XI_PRM_REGIONS_GEOMETRY
        '''
        return self.get_param('regions_geometry')

    def get_regions_geometry_maximum(self):
        '''
        Type of multiple regions geometry.XI_PRM_REGIONS_GEOMETRY
        '''
        return self.get_param('regions_geometry:max')

    def get_regions_geometry_minimum(self):
        '''
        Type of multiple regions geometry.XI_PRM_REGIONS_GEOMETRY
        '''
        return self.get_param('regions_geometry:min')

    def get_regions_geometry_increment(self):
        '''
        Type of multiple regions geometry.XI_PRM_REGIONS_GEOMETRY
        '''
        return self.get_param('regions_geometry:inc')
